          ...
          <div className="hero__card-wrap">
            <div className="hero__card hero__card--enter">
              <div className="hcard__header">
                ...
                <span className="hcard__live">LIVE</span>
              </div>
        ...
        <div className="hc services-showcase__inner">
          ...
          >
            {services.map((service, index) => {
              ...
              const visual =
                SERVICE_VISUALS[service.slug] || SERVICE_VISUALS['individual-tax-return'];

              return (
                <Link
                  to="/services"
                  key={service.slug}
                  className={`service-tile service-tile--${index + 1} reveal-up ${activeService === index ? 'is-active' : ''}`}
                  role="listitem"
                >
                  <div className="service-tile__media">
                    ...
                    />
                    <span className="service-tile__chip">{visual.chip}</span>
                  </div>
                  ...
                  <div className="service-tile__body">
                    <div className="service-tile__meta">
                      ...
                      <span className="service-tile__num">0{index + 1}</span>
                    </div>

                    {index === 0 && (
                      <span className="service-tile__badge">Most popular</span>
                    )}

                    <h3 className="service-tile__title">{service.title}</h3>
                    <p className="service-tile__desc">{service.short}</p>
          ...
          <div className="services-showcase__dots">
            {services.map((_, idx) => (
              <button
                key={idx}
                className={`services-showcase__dot ${activeService === idx ? 'is-active' : ''}`}
